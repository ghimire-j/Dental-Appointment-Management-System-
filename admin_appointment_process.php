...
use PHPMailer\PHPMailer\PHPMailer; //importing name space doing this when 
use PHPMailer\PHPMailer\Exception; //keep in any function or if block = error 
use PHPMailer\PHPMailer\autoload; //namespace / secondary class
...
$to = $email;
        ...
        $message = "Hello " . $first_name . ",<br><br>This is a friendly reminder that you have an appointment scheduled with us at " . $appointment_date . ". Please remember to arrive on time.<br><br>Best regards,<br> Admin<br><br>
        नमस्ते " . $first_name . ", यो एक मैत्रीपूर्ण रिमाइन्डर हो कि तपाइँले "  . $appointment_date . " मा हामीसँग भेट्ने समय तय गर्नुभएको छ।<br><br> समयमै आइपुग्न नभुल्नु होला।<br><br> हार्दिक बधाई,<br> प्रशासक";
      ...
      // Send email using PHPMailer
        ...
        $mail->SMTPSecure = 'tls';
        $mail->Port = 587;
        $mail->setFrom('jubingc15@gmail.com', 'Admin_Kathmandu Dental'); 
        $mail->addAddress($to);
        $mail->isHTML(true);
    ...
    if (!$appointment_row) {
        echo "Error: Appointment not found.";
         ...
         // Generate invoice HTML
            $invoice_html = "<html><head><style> <br> <br> <br> table {border-collapse: collapse; width: 80%; margin: 0 auto; font-family: Arial, sans-serif; color: #333;} th, td {text-align: left; padding: 8px;} tr:nth-child(even){background-color: #f2f2f2}</style></head><body>";
